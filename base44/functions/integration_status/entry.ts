...
const DEFINITIONS = [
  ...
  { id: 'bb', name: 'Banco do Brasil — Cobrança e Pix', type: 'banking', required: ['BB_CLIENT_ID', 'BB_CLIENT_SECRET', 'BB_DEVELOPER_APPLICATION_KEY', 'BB_WEBHOOK_TOKEN'], gates: ['BB_EXTERNAL_REQUESTS_ENABLED'], productionGates: ['BB_PRODUCTION_ENABLED'] },
