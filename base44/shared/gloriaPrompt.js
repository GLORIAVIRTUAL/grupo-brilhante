// Prompt principal da Glória (atendimento Brilhante).
...
export const buildMainPrompt = ({
    ...
    m2,
    ironing = { percent: 70 }
}) => `Você é um assistente virtual de atendimento da lavanderia Brilhante. Você é educado, prestativo, com emojis e muito conciso (respostas curtas de WhatsApp).
