    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          <h1 className="flex items-center gap-3 text-3xl font-bold text-white">
            <Megaphone className="w-8 h-8 text-[#216FA1]" />
            Tráfego Pago
          </h1>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="bg-white/5 border border-white/10 p-1">
          <TabsTrigger value="research" className="data-[state=active]:bg-[#216FA1] data-[state=active]:text-white gap-2">
            <Lightbulb className="w-4 h-4" /> Pesquisar
          </TabsTrigger>
          <TabsTrigger value="create" className="data-[state=active]:bg-[#216FA1] data-[state=active]:text-white gap-2">
            <Rocket className="w-4 h-4" /> Criar & Programar
          </TabsTrigger>
          <TabsTrigger value="results" className="data-[state=active]:bg-[#216FA1] data-[state=active]:text-white gap-2">
