...
const empty = { catalog_type: 'color', label: '', code: '', unit_id: '', synonyms: '', category: '', description: '', color_hex: '#216FA1', favorite: false, sort_order: 0, active: true, change_reason: '' };
