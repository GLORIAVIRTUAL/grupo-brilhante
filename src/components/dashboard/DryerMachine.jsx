...
export default function DryerMachine({ label = 'SECAR 1', code = 'DRY-7000' }) {
  return (
    <div className="relative flex flex-col items-center">
      ...
      <div className="w-32 h-44 md:w-40 md:h-48 bg-white/5 backdrop-blur-md rounded-2xl border border-white/20 relative overflow-hidden flex flex-col shadow-[0_0_30px_rgba(33,111,161,0.3)]">
        {/* Header */}
        ...
        <div className="flex-1 relative flex items-center justify-center">
          ...
          <motion.div
            ...
            className="w-24 h-24 md:w-28 md:h-28 rounded-full border-2 border-dashed border-blue-400/30 absolute"
          />
          {/* Inner Heated Core */}
          <div className="w-20 h-20 md:w-24 md:h-24 rounded-full bg-gradient-to-tr from-[#216FA1]/20 to-orange-400/20 backdrop-blur-sm border border-blue-400/50 relative overflow-hidden shadow-inner">
            <motion.div
              animate={{ rotate: 360 }}
            ...
            >
              ...
              <div className="absolute top-1/2 left-3 w-3 h-3 bg-blue-300 rounded-md shadow-[0_0_10px_#2d8ac4]" />
            </motion.div>
          </div>
