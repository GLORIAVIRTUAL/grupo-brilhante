    ...
    <Card className="border-white/10 bg-white/5">
      <CardHeader className="space-y-4">
        <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
          <div><CardTitle className="flex items-center gap-2 text-white"><ShieldAlert className="h-5 w-5 text-blue-300" />Central de Auditoria</CardTitle><CardDescription className="mt-1 text-gray-300">Eventos de segurança, financeiro, estoque, produção, CRM e logística com correlação e histórico antes/depois.</CardDescription></div>
