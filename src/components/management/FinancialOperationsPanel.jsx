  ...
  return (
    <section className="space-y-6">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex flex-wrap gap-2"><Button variant="outline" onClick={onCash} className="border-white/10 bg-white/5"><Banknote className="mr-2 h-4 w-4" />Operar caixa</Button><Button onClick={onNewBill} className="bg-gradient-to-r from-sky-500 to-[#216FA1]"><ScanLine className="mr-2 h-4 w-4" />Ler conta</Button></div>
      </div>
